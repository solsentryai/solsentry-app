    ...
    <section className="case">
      <div className="container">
        ...
        <div className="case-grid">
          <div>
            <p style={{ color: "var(--fg-2)", marginBottom: 20, lineHeight: 1.6 }}>
              Operator <span className="mono" style={{ color: "var(--brand-orange)" }}>4kxscute...</span> had
              already rugged 61 tokens. On deployment #62, SolSentry flagged it as HIGH RISK
              four minutes after launch. The operator executed the rug 19 minutes later.
            </p>
            <p style={{ color: "var(--fg-2)", marginBottom: 20, lineHeight: 1.6 }}>
              Downstream integrators who monitor SolSentry alerts received a{" "}
              <strong style={{ color: "var(--status-critical)" }}>CRITICAL</strong> signal before a single token
              was actually drained. No real-time transaction analysis was needed — the operator&rsquo;s
              historical pattern was the signal.
            </p>
            <p style={{ color: "var(--fg-3)", fontSize: 13, fontFamily: "var(--font-mono)" }}>
              Verify yourself:
              <br />
