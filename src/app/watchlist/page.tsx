...
export const metadata = {
  ...
  description: "Paste wallet addresses. SolSentry polls each one against the operator database and surfaces status. Stored locally in your browser, not on any server.",
};
    ...
    <>
      ...
      <main>
        <PageHeader
          ...
          title={
            <>
              Track the wallets <span style={{ color: "var(--brand-orange)" }}>that matter to you</span>.
            </>
          }
        ...
        >
          <div className="grid-3">
            {[
              { t: "No signup", d: "You never create an account. No email. No wallet signature. No cookie tracking." },
              { t: "No server state", d: "Your list is written to localStorage. When you clear the browser, it's gone. Nothing to leak." },
              { t: "Portable", d: "Export JSON any time. Import on another machine. Or paste it into a Telegram /import command." },
            ].map((c) => (
