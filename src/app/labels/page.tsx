...
export const metadata = {
  ...
  description: "Tag any Solana wallet with a private human-readable label. Stored in your browser. Shows up next to the address on every SolSentry page.",
};
    ...
    <>
      ...
      <main>
        <PageHeader
          ...
          title={
            <>
              Replace <span style={{ fontFamily: "var(--font-mono)" }}>9mQsY9...L5pH1</span> with{" "}
              <span style={{ color: "var(--brand-orange)" }}>&quot;suspicious dev #3&quot;</span>.
            </>
          }
        ...
        >
          <div className="grid-3">
            {[
              { t: "Operator pages", d: "Your label renders above the wallet header. If the wallet is also in the global entity registry, both labels show side-by-side." },
              { t: "Leaderboard", d: "Labels replace the address in the rank list. Makes reviewing known-bad-actor lists much faster." },
              { t: "Drain traces", d: "Hop destinations show your label when matched, so the flow reads like a story instead of a random string of base58." },
            ].map((c) => (
