...
export const metadata = {
  title: "About SolSentry — operator-centric threat intel for Solana",
  description:
    "SolSentry tracks the operators behind Solana scams. Live mainnet metrics, 4kxscute case study, MCP/Telegram/REST surfaces.",
};
