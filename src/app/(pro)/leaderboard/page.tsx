        ...
        <section className="hero" style={{ padding: "80px 0 32px" }}>
          <div className="container">
            ...
            <p className="hero-sub">
              Wallets ranked by confirmed rug deployments. Click any wallet to
              inspect full operator profile and deployment timeline.
            </p>
          </div>
        </section>
          ...
          <div className="container">
            {operators.length === 0 ? (
              <div className="empty-state">
                Failed to load leaderboard. The API may be temporarily
                unavailable.
              </div>
            ) : (
              <div className="lb-table">
                ...
                {operators.map((op) => (
                  ...
                  >
                    ...
                    <span className="lb-wallet mono">
                      {truncate(op.wallet, 8, 6)}
                    </span>
